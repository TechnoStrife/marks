...
;(function ($, anim) {
  ...
  var Dropdown = function (_Component2) {
    ...
    function Dropdown(el, options) {
       ...
       * @prop {Function} onOpenStart - Function called when dropdown starts now_opening
       * @prop {Function} onOpenEnd - Function called when dropdown finishes now_opening
  ...
  var Modal = function (_Component3) {
    ...
    _createClass(Modal, [{
      ...
      value: function open($trigger) {
        ...
        // Set now_opening trigger, undefined indicates modal was opened by javascript
